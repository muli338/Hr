              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" name="region_name" class="form-control" value="{{ Request()->region_name }}" placeholder="Enter Regions Name">
                  </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                       ...
                       <a href="{{ url('admin/regions/delete/' .$value->id)}}" onclick="return confirm('Are you sure you want to delete this Region?')" class="btn btn-danger">Delete</a>
                    </td>
                    </tr>
                    @empty
                    <tr>
