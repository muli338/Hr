      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <input type="hidden" name="start_date" value="{{Request()->start_date }}">
            ...
            <a class="btn btn-success" href="{{ url('admin/job_history_export?start_date='.
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" name="job_title" class="form-control" placeholder="Job Name" value="{{ Request()->job_title }}">
                  </div>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <a href="{{ url('admin/job_history/delete/' .$value->id)}}" onclick="return confirm('Are you sure you want to delete the employee?')" class="btn btn-danger">Delete</a>
                      </td>
                    </tr>
                    @empty
                    <tr>
