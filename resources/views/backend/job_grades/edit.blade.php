                    ...
                    <div class="card card-info">
                        ...
                        <form  class="form-horizontal" method="post" action="{{ url('admin/job_grades/edit/' .$getRecord->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                               ...
                               <div class="col-sm-10">
                               <input type="text" value="{{ $getRecord->grade_level }}" name="grade_level" class="form-control" placeholder="Enter Job Grade" required>
                               </div>
                            </div>
                            ...
                            <div class="form-group row">
                               ...
                               <div class="col-sm-10">
                               <input type="number" value="{{ $getRecord->lowest_sal }}" name="lowest_sal" class="form-control" placeholder="Enter Lowest Salary" required>
                               </div>
                            </div>
                            ...
                            <div class="form-group row">
                               ...
                               <div class="col-sm-10">
                               <input type="number" value="{{ $getRecord->highest_sal }}" name="highest_sal" class="form-control" placeholder="Enter Highest Salary" required>
                               </div>
                            </div>
