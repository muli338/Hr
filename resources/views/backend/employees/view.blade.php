                    ...
                    <div class="card card-info">
                        ...
                        <form  class="form-horizontal" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                               ...
                               <div class="form-group row">
                                <label class="col-sm-2 col-form-lable">Manager Title<span style="color: red;">*</span></label>
                               <div class="col-sm-10">
                               ...
                               <div class="col-sm-10">
                               {{ !empty($getRecord->get_department_name->department_name) ? 
                                $getRecord->get_department_name->department_name : '' }}
                               </div>
                               </div>
